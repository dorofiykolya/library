package common.composite
{
	...
	public class Entity extends Component
	{
		...
		public override function broadcastEventWith(type:String, bubbles:Boolean = false, data:Object = null):void
		{
		...
		public override function broadcastEventAs(typeEvent:Class, type:String, ... args):void
		{
		...
		internal function getChildEventListeners(object:Component, eventType:String, listeners:Vector.<Component>):void
		{
